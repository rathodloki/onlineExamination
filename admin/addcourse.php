...
<body>
    <form id="form1" action="addcourse.php" method="post">
     <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
    ...
    <div id="site_content" style="background-image: none">
      <div id="content" style=" width: 1000px; height: auto;min-height:590px">
        <div class="add">
          ...
          <input type="text" class="inadd" placeholder="Course name" autocomplete="off" name="c_name" required></input><br>
          <hr>

         
          <input class="qadd"type="submit" id="addques" name="addques"  value="Add Subject" />
